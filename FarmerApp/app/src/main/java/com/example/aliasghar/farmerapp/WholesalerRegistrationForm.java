...
public class WholesalerRegistrationForm extends AppCompatActivity {

    Button wholesalerRegisterFormBackButton, wholesalerRegisterFormNextButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wholesaler_registration_form);

        wholesalerRegisterFormBackButton = (Button)findViewById(R.id.wholesalerRegisterFormBackButton);
        wholesalerRegisterFormNextButton = (Button)findViewById(R.id.wholesalerRegisterFormNextButton);
        ...
        wholesalerRegisterFormBackButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WholesalerRegistrationForm.this,RegisterAs.class);
                startActivity(intent);
            }
        });

        wholesalerRegisterFormNextButton.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void registerWholesalers() {
        ...
        String type = "wholesalerRegister";
